...
;	// create shortcut
	...
	gui, add, Text, xp+30 yp+5 backgroundtrans gshortcutCreate, % T.CREATE_SHORTCUT
...
; 	// login button
	...
	Gui, Add, Picture, glogin x542 y392 h30 w125 backgroundtrans, %APPDATA%\button-green-big.png
