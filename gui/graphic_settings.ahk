...
gui, 3:Tab, 1
	gui, 3:add, button, gGraphicSettingsGuiCancel x255 y275, % T.GRAPHIC_SETTINGS_CANCEL
	gui, 3:add, button, gGraphicSettingsGuiOk x330 y275, % T.GRAPHIC_SETTINGS_SAVE
	gui, 3:show
